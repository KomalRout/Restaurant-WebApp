              ...
              <div className="flex items-center gap-[46px] md:flex-col">
                <div className="flex flex-col items-center gap-[50px] md:self-stretch">
                  <div className="flex flex-col gap-12 self-stretch">
                    ...
                    <div className="gap-[30px] grid grid-cols-3 justify-center gap-y-6 md:grid-cols-2 sm:grid-cols-1">
                ...
                <div className="w-[32%] md:w-full">
                  <div className="rounded-[20px] shadow-[0_4px_29px_0_#60676933] bg-[#ffffff] gap-[50px] flex flex-col py-11 md:py-5">
